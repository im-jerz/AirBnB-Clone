...
function EmptyCabinIllustration() {
  return (
    <svg className="empty-state-illo" viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M40 108 L80 70 L120 108 Z" fill="#1C3A2F" />
      <rect x="52" y="100" width="56" height="36" rx="2" fill="#FBF9F4" stroke="#1C3A2F" strokeWidth="1.5" />
      <rect x="72" y="116" width="16" height="20" fill="#1C3A2F" />
      <rect x="58" y="106" width="10" height="10" fill="#C9A84C" opacity="0.85" />
      <rect x="92" y="106" width="10" height="10" fill="#C9A84C" opacity="0.85" />
      <path d="M96 76 L96 58 L106 58 L106 86" fill="#1C3A2F" />
      <path d="M30 108 H130" stroke="#1C3A2F" strokeWidth="1.5" strokeLinecap="round" opacity="0.4" />
