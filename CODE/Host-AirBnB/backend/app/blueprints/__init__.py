...
def register_blueprints(app):
    ...
    # Other blueprints (availability, bookings, payments, reviews,
    # guests, messages, notifications, support, settings, admin_api)
    # are registered here as they're implemented in later phases —
    # see Section 8 (Implementation Plan).
